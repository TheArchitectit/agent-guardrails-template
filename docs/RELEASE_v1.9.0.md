...
#### Production Deployment (AI01)

Successfully deployed to AI01 (RHEL 8 + Podman):
...
### MCP Protocol
```
http://100.96.49.42:8092/mcp/v1/sse
http://100.96.49.42:8092/mcp/v1/message
```
...
scp .env user001@100.96.49.42:/opt/guardrail-mcp/
scp deploy/podman-compose.yml user001@100.96.49.42:/opt/guardrail-mcp/
...
```json
{
  "mcpServers": {
    "guardrails": {
      "url": "http://100.96.49.42:8092/mcp/v1/sse",
      "headers": {
...
```bash
curl -s -X POST http://100.96.49.42:8092/mcp/v1/message \
...
```bash
curl -s -N http://100.96.49.42:8092/mcp/v1/sse
```
