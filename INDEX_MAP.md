...
|---------|----------|------|---------|
| quick-setup | QUICK_SETUP.md | docs/ | **5-minute setup guide** ⭐ |
| prompting | PROMPTING_GUIDE.md | docs/standards/ | **Master prompting techniques** ⭐ |
...
| **CHANGELOG.md** | MCP server version history (merged into root CHANGELOG.md) | When tracking version history |
...
**Document Count:** See TOC.md for current document count
**Line Count:** ~280
