// Migration runner for your-server database
// Usage: go run scripts/run_migrations.go <database_url>
// Example: go run scripts/run_migrations.go "postgresql://guardrail:example-db-password@localhost:5432/guardrail?sslmode=disable"
